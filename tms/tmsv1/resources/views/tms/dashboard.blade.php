...
<section class="content">
    ...
    <div class="row">
        <div class="col-xs-12" id="dailyWrapper">
            ...
            <div class="box-header">
                <h3 class="box-title"><i class="fa fa-exclamation-circle"></i> Daily Goals</h3>
            </div>
                <div class="box-body">
    ...
    <div class="row">
        <div class="col-xs-12" id="sgWrapper">
            ...
            <div class="box-header" style="color: #FFF;background-color: #00a65a;">
                <h3 class="box-title"><i class="fa fa-exclamation-triangle"></i> Eat That Frog <i class="fa fa-arrow-right" style="padding: 0 10px;"></i> Goal #1</h3>
            </div>
                <div class="box-body">
    ...
    <div class="row">
        ...
        <div class="small-box bg-aqua">
          ...
          <a href="{{url('/')}}/goals" class="small-box-footer">GO <i class="fa fa-arrow-circle-right"></i></a>
        </div>
        </div>
        <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-orange">
          ...
          <a href="{{url('/')}}/habits" class="small-box-footer">GO <i class="fa fa-arrow-circle-right"></i></a>
        </div>
        </div>
        <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-yellow">
          ...
          <a href="{{url('/')}}/mindstorm" class="small-box-footer">GO <i class="fa fa-arrow-circle-right"></i></a>
        </div>
        </div>
        <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-red">
          ...
          <a href="{{url('/')}}/readinglist" class="small-box-footer">GO <i class="fa fa-arrow-circle-right"></i></a>
        </div>
        </div>
    </div>
    <!-- Module Boxes End -->
