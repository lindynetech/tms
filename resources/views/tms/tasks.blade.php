...
<section class="content-header">
    <h1><i class="fa fa-tasks"></i> Tasks <img src="/assets/images/q.png" class="help-tooltip" id="taskstp"></h1>
    <small><a href="{{url('/goals')}}"><i class="fa fa-arrow-left"></i> <b>Back to Goals</b></a></small>
    <ol class="breadcrumb">
...
<div id="taskstpcontent" style="display: none;">
    <p><b>Tasks</b></p>
    <ul>
        <li>Plan every goal by listing tasks to complete</li>
        <li>You can split any taks into subtasks by setting type to Objective. You will see <span class="glyphicon glyphicon-zoom-in"></span> icon, press it to start adding/view subtasks</li>
        <li>To delegate tasks add a new vendor</li>
        <li>As you complete every task you are closer to accomplishing your goal, there will be a progress bar on All Goals page</li>
    </ul>
...
<section class="content">
    <div class="row">
        <div class="col-xs-12" id="sgWrapper">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-pencil"></i> {{$goalName}}</h3>
    ...
    <div class="row">
        <div class="col-xs-12" id="tasksWrapper">
            <p><a href="/vendors"><i class="fa fa-barcode"></i> <b>Add a vendor/assignee</b></a></p>
            <div class="box box-success">
                <div class="box-body">
